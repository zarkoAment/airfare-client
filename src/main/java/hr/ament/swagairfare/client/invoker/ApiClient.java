...
import hr.ament.swagairfare.client.invoker.auth.Authentication;
import hr.ament.swagairfare.client.invoker.auth.HttpBasicAuth;
import hr.ament.swagairfare.client.invoker.auth.ApiKeyAuth;
...
@Component("hr.ament.swagairfare.client.invoker.ApiClient")
public class ApiClient {
    ...
    protected void init() {
        ...
        authentications.put("airfare_auth", new OAuth());
